...
public class Calculator extends JFrame{
    ...
    public Calculator() {
        ...
        this.setTitle("Ingenear calculator");
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(start) {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Sorry, the number is wrong," +
                                    " please re-enter!",
                            "Error!", JOptionPane.ERROR_MESSAGE);

                    throw new NumberFormatException("Digital format error");
                ...
                if(Double.parseDouble(jTextField.getText()) < 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "Sorry, the factorial calculation" +
                                    " cannot be negative",
                            "Error!", JOptionPane.ERROR_MESSAGE);

                    jTextField.setText("Sorry, the factorial calculation cannot be negative");

                    start = true;

                    throw new IllegalArgumentException("Factorial calculations have negative numbers");
                ...
                if(!start) {
                    ...
                    if(command.equals("+"))
                        ...
                        if(Double.parseDouble(jTextField.getText()) != 0) {
                            ...
                            jTextField.setText(""+"Sorry, the divisor cannot be zero");

                            JOptionPane.showMessageDialog(null, "Sorry, the divisor cannot be zero",
                                    "Error!", JOptionPane.ERROR_MESSAGE);
